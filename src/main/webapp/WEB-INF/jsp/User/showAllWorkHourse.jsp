...
<script>
    ...
    function findByCondition() {
        ...
        layui.use('table', function () {
            ...
            table.reload("table", {
                height: 650
                ,
                url: 'findWorkHourse.action' //数据接口
                ,
                where: {
                    "sort": sort
                }
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'w_workDetail', title: '工作详情', width: 746}
    ...
    /*添加工时*/
    function addWokHourse() {
        var height = 500;
        var width = 600;
        var top = Math.round((window.screen.height - height) / 2);
        var left = Math.round((window.screen.width - width) / 2);
        window.open("addWorkHourseHtml.action", "_blank",
...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn"
                onclick="addWokHourse()">
            <i class="layui-icon"></i>添加今日工时
        </button>
    </xblock>
