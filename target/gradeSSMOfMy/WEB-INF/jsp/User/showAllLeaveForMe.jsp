...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'l_reason', title: '审核人意见', width: 460}
    ...
    layui.use('table', function () {
        ...
        table.on('tool(test)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            var id = data.l_id;
            var confirm = data.l_confrim;
            if (layEvent === 'ok') { //
                if (confirm == 0) {
                    $.ajax({
                        type:"post",
                        url:"updateLeaveOk.action",
                        data:{"id":id},
                ...
                window.open("addLeaveReason.action?id="+id, "_blank",
