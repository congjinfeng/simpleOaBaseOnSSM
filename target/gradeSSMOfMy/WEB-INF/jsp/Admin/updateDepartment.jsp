    ...
    function addDepartment() {
        ...
        if (hrid != null && manid != null && name != null) {
            $.ajax({
                ...
                data: {"id": ${requestScope.department.d_id}, "hr": hrid, "man": manid, "name": name},
                success: function (data) {
                    if (data == "success") {
                        layui.use("layer", function () {
                            layer = layui.layer;
                            layer.msg("更新成功，即将刷新界面", {icon: 1, time: 2000});
                            setTimeout("refresh()", 2000)
                        })
                    } else {
                        layui.use("layer", function () {
                            layer = layui.layer;
                            layer.msg("更新失败，该部门已经存在相同名称的子部门", {icon: 5, time: 2000});
                        })
                    }
                }
            })
            ...
            layui.use("layer", function () {
                layer = layui.layer;
                layer.msg("抱歉，数据有误，无法更新", {icon: 5, time: 2000});
            })
        }
    }
</script>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="name" required
                   class="layui-input" value="${requestScope.department.d_name}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="position: relative">
            <input type="text" id="man" required
                   class="layui-input" value="${requestScope.department.u_manId}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="position: relative">
            <input type="text" id="hr" required
                   class="layui-input" value="${requestScope.department.u_hrId}">
